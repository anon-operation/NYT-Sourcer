...
##                print(lower, section, url, fixedDate, title, count,"known_method2",sep=",", file=outfile)
    ...
    successMessage="Written to file SlimtoDatabaseData.txt"
...
if str(Q1)=="1":
    outfile = open("SlimtoDatabaseData.txt", "w", encoding='utf-8')
    data=load_NYT_data()
    print(data)
if str(Q1)=="2":
    print("To split, type: split -l 100000 SlimtoDatabaseData.txt Slim_Sept_split_")
if str(Q1)=="3":
    import glob
    reads=glob.glob("Slim_Sept_split_*")
