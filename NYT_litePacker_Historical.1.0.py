...
prefixFile=input("Please type the name of the .pickle file you'd like to add to. You don't need to type the .pickle part. ")
suffix=".pickle"
...
your_key = ""
getReq=("https://api.nytimes.com/svc/archive/v1/2020/9.json?api-key="+your_key)
